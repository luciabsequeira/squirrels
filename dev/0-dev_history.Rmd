...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "The coolest package",
    Description = "Squirrels love acorns",
    `Authors@R` = c(
      person("Lucia", "Sequeira", email = "luciabsequeira@gmail.com", role = c("aut", "cre"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Lucia Sequeira")
```
